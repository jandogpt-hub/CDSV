    <nav>
        ...
        <div class="nav-links">
            ...
            <div class="nav-item has-dropdown">
                ...
                <div class="dropdown">
                    <a href="/services/interior-detailing.php" class="dropdown-link">Interior Detailing</a>
                    <a href="/services/surface-protection.php" class="dropdown-link">Surface Protection & Coating</a>
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <div class="dropdown" id="mobileServicesDropdown">
            <a href="/services/interior-detailing.php" class="dropdown-link">Interior Detailing</a>
            <a href="/services/surface-protection.php" class="dropdown-link">Surface Protection</a>
            <a href="/services/specialty-restoration.php" class="dropdown-link">Specialty & Restoration</a>
            <a href="/services/full-detail.php" class="dropdown-link">Full Detail Package</a>
        </div>

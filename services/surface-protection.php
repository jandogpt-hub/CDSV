...
<?php include '../globalheader.php'; ?>
    ...
    <main>
        <section class="hero">
            ...
            <div class="sub-data">
                <div>
                    [ PERMANENT PAINT DEFENSE ]<br>
                    CERAMIC · PPF · SEALANTS
                </div>
                <div>
                    CARFAX REGISTERED<br>
                    5, 7 & 10 YEAR WARRANTIES
                </div>
            </div>
        </section>

        <!-- Ceramic Coating -->
        <section id="ceramic-coating" style="padding: 80px 40px; max-width: 1100px; margin: 0 auto; border-bottom: 1px solid var(--border);">
            <h2 style="font-size: 2rem; margin-bottom: 20px; text-transform: uppercase; font-family: var(--font-sans);">Ceramic Coating</h2>
            <p style="font-family: var(--font-mono); font-size: 0.85rem; color: var(--muted); line-height: 1.8; margin-bottom: 40px;">
                Our Flight Shield nano-ceramic technology creates a permanent, hydrophobic barrier that bonds to your clear coat at the molecular level. Unlike wax that washes away in weeks, ceramic coatings last years—and every application is registered on Carfax.
            </p>
            ...
            <!-- Elite Package -->
            <div id="elite-ceramic" style="border: 1px solid var(--border); padding: 40px; margin-bottom: 30px;">
                <div style="display: flex; justify-content: space-between; align-items: start; flex-wrap: wrap; gap: 20px; margin-bottom: 25px;">
                    <div>
            ...
            <!-- Upgrade Options -->
            <h4 style="font-family: var(--font-mono); font-size: 0.9rem; margin: 40px 0 20px; color: var(--accent);">CERAMIC COATING ADD-ONS</h4>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; font-family: var(--font-mono); font-size: 0.75rem; color: var(--muted);">
                <div style="border: 1px solid var(--border); padding: 15px;">→ Upgrade to 7-Year</div>
                <div style="border: 1px solid var(--border); padding: 15px;">→ Upgrade to 10-Year</div>
                <div style="border: 1px solid var(--border); padding: 15px;">→ Glass Hydrophobic Coating</div>
                <div style="border: 1px solid var(--border); padding: 15px;">→ Interior Fabric & Leather Coating</div>
                <div style="border: 1px solid var(--border); padding: 15px;">→ Ceramic Coat Rims (Outer)</div>
                <div style="border: 1px solid var(--border); padding: 15px;">→ Ceramic Coat Rims (Inner & Outer)</div>
            </div>
        </section>

        <!-- Paint Protection Film -->
        <section id="ppf" style="padding: 80px 40px; max-width: 1100px; margin: 0 auto; border-bottom: 1px solid var(--border);">
            <h2 style="font-size: 2rem; margin-bottom: 20px; text-transform: uppercase; font-family: var(--font-sans);">Paint Protection Film (PPF)</h2>
            <p style="font-family: var(--font-mono); font-size: 0.85rem; color: var(--muted); line-height: 1.8; margin-bottom: 40px;">
                Clear, self-healing film that creates a physical barrier against rock chips, road debris, bug acids, and minor abrasions. The ultimate protection for high-impact areas.
            </p>
        ...
        <!-- Traditional Wax & Sealants -->
        <section id="wax-sealants" style="padding: 80px 40px; max-width: 1100px; margin: 0 auto;">
            <h2 style="font-size: 2rem; margin-bottom: 20px; text-transform: uppercase; font-family: var(--font-sans);">Traditional Wax & Sealants</h2>
            <p style="font-family: var(--font-mono); font-size: 0.85rem; color: var(--muted); line-height: 1.8; margin-bottom: 40px;">
                For clients who prefer traditional protection methods or want to maintain their vehicle between ceramic coating appointments.
            </p>
